      ...
      <section className="relative z-10 py-14 flex-grow">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative">
            {/* CORNER DECARATION */}
            <div className="absolute -top-10 left-[-10] w-40 h-40 border-l-2 border-t-2" />
            ...
            <div className="lg:col-span-7 space-y-4 relative">
              <h1 className="text-3xl md:text-4xl lg:text-6xl font-bold tracking-tight">
                ...
                <div className="pt-2">
                  <span className="text-foreground">Usando a </span>
                </div>
                <div className="pt-2">
              ...
              <p className="text-xl text-muted-foreground w-2/3">
                Fale com nosso assistente de IA, para obter treinos e dietas
