      ...
      <div className="container mx-auto max-w-6xl px-4">
        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-8 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              <span className="text-primary">Treinos</span>
              <span className="text-foreground"> Gerados por IA </span>
            </h2>

            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              Explore treinos e dietas personalizados que nosso assistente de IA
              criou para outros usuários.
            </p>
                ...
                <div className="space-y-5 pt-2">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        Sistemas de proteção habilitados
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="mt-16 text-center">
          <Link href="/generate-program">
            ...
            >
              Gere seu Treino e Dieta
              <Sparkles className="ml-2 h-5 w-5" />
            </Button>
          </Link>
          <p className="text-muted-foreground mt-4">
            Junte-se a mais de 20 usuários com treinos e dietas personalizados
            por IA
          </p>
        </div>
      </div>
